...
public class OctoBoost extends AbstractOctoCard {

    public static final String ID = OctoMod.makeID("OctoBoost");
    public static final String IMG = makeCardPath("OctoBoost.png");
