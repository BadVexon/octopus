...
public class PocketStrangulation extends AbstractOctoCard {

    public static final String ID = OctoMod.makeID("PocketStrangulation");
    public static final String IMG = makeCardPath("PocketStrangulation.png");
