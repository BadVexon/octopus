...
import theOctopus.powers.DuplicatePower;

import static theOctopus.OctoMod.makeCardPath;


public class Duplicate extends AbstractOctoCard {

    public static final String ID = OctoMod.makeID("Duplicate");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new DuplicatePower(1), 1));
    }
