...
public class Boosted extends AbstractOctoCard {

    public static final String ID = OctoMod.makeID("Boosted");
    public static final String IMG = makeCardPath("Boosted.png");
