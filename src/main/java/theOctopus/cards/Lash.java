...
public class Lash extends AbstractChoiceCard {

    public static final String ID = OctoMod.makeID("Lash");
    public static final String IMG = makeCardPath("Lash.png");
    ...
    public ArrayList<OctoChoiceCard> choiceList(AbstractMonster m) {
        ...
        list.add(new OctoChoiceCard("Attack", "Attack", makeCardPath("Lash.png"), "Deal !D! damage.", AbstractCard.CardType.ATTACK, this.damage, -1));
        list.add(new OctoChoiceCard("Block", "Block", makeCardPath("SkillLash.png"), "Gain !B! Block.", AbstractCard.CardType.SKILL, -1, this.block));
        return list;
    }
